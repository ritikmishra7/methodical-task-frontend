    ...
    return (
        <Layout className='chat-layout'>
            <div className='header'>
                <div className="icon">
                    {activeProjectDetails.thumbnail ? <img src={activeProjectDetails.thumbnail} alt="project" className="chat-profile-image" /> : <Avatar className="chat-profile-image">{getInitals(activeProjectName)}</Avatar>}
